...
export const electronicMaterials = [
  ...
  // ─── PROCESORY ────────────────────────────────────────────────────────────
  {
    ...
    weightPerPiece: 0.040,
    metalContentPerKg: {
      Au: { min: 5.0, max: 18.0, typical: 9.5 },
      Ag: { min: 1.0, max: 5.0, typical: 2.5 },
      Pt: { min: 0.0, max: 0.15, typical: 0.06 },
      Pd: { min: 0.08, max: 0.60, typical: 0.28 },
    },
    notes: "Ceramiczne procesory Intel 286/386/486 (~40g/szt) — złota pokrywa (lid), złocone nóżki, gold bond wires w IC. Dane assay (goldrefiningforum): Au ~7-10 g/kg typowo, do 18 g/kg dla modeli wojskowych. metalContentPerKg = wartość dla całego procesora z ceramiką i nóżkami.",
  },
  {
    id: "cpu_ceramic_2str",
  ...
  },
  {
    ...
    weightPerPiece: 0.040,
    metalContentPerKg: {
      Au: { min: 2.0, max: 7.0, typical: 4.0 },
      Ag: { min: 0.8, max: 3.5, typical: 2.0 },
      Pt: { min: 0.0, max: 0.10, typical: 0.04 },
      Pd: { min: 0.03, max: 0.25, typical: 0.12 },
    },
    notes: "Ceramiczne procesory ze złotem tylko na jednej stronie (dół lub góra, ~40g/szt). Assay data: Au 3.59-5.82 g/kg dla typowej partii (goldrefiningforum).",
  },
  {
  ...
  // ─── PAMIĘCI RAM ──────────────────────────────────────────────────────────
  {
    ...
    metalContentPerKg: {
      Au: { min: 0.01, max: 0.08, typical: 0.04 },
      Ag: { min: 2.50, max: 5.50, typical: 3.80 },
      Pt: { min: 0.0, max: 0.003, typical: 0.001 },
      Pd: { min: 0.0, max: 0.02, typical: 0.008 },
    },
    notes: "Kości RAM ze stykami cynowymi DDR3/4/5 (~30g/szt DIMM). GŁÓWNE źródło Ag: lutowie SnAg (RoHS) — ~3-5 g/kg. Styki 'srebrne' to w rzeczywistości cyna — prawie brak Au i Pd. Dla ekstrakcji Ag lepszy elektroliz lub inne procesy selektywne niż woda królewska.",
  },
  {
    id: "ram_zlote",
    ...
    weightPerPiece: 0.040,
    metalContentPerKg: {
      Au: { min: 0.50, max: 2.50, typical: 1.10 },
      Ag: { min: 0.15, max: 1.80, typical: 0.60 },
      Pt: { min: 0.0, max: 0.008, typical: 0.003 },
      Pd: { min: 0.02, max: 0.20, typical: 0.08 },
    },
    notes: "Kości RAM ze złotymi stykami SDR/DDR1/DDR2 (~40g/szt DIMM) — bez aluminium. GŁÓWNE źródło Au: grube złocenie styków kontaktowych (0.1-0.5 µm × 184-240 kontaktów). Ag niska — lutowie Pb-Sn era pre-RoHS nie zawiera Ag. Pd śladowe z MLCC starszej generacji. Dane rynkowe: skup oferuje 250-400 zł/kg → wskazuje Au ~0.8-1.5 g/kg.",
  },
  {
    id: "ram_simm",
    ...
    weightPerPiece: 0.040,
    metalContentPerKg: {
      Au: { min: 0.80, max: 3.00, typical: 1.50 },
      Ag: { min: 0.20, max: 1.80, typical: 0.80 },
      Pt: { min: 0.0, max: 0.02, typical: 0.01 },
      Pd: { min: 0.05, max: 0.40, typical: 0.18 },
    },
    notes: "Stare pamięci SIMM/EDO/FPM (30-pin/72-pin, ~40g/szt, przed ~1998) — bardzo grube złocenie styków z ery pre-JEDEC (do 2.5 µm Au). Wyższe Pd niż DDR — starsze MLCCs miały elektrody Pd-Ag. Lutowie Pb-Sn → brak Ag z lutowia.",
  },
