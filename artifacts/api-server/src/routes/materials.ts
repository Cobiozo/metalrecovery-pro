...
export const electronicMaterials = [
  ...
  },
  {
    ...
    metalContentPerKg: {
      ...
      Ag: { min: 0.5, max: 5.0, typical: 1.5 },
      Pt: { min: 0.0, max: 0.01, typical: 0.002 },
      Pd: { min: 0.0, max: 0.05, typical: 0.015 },
    },
    chemFraction: 0.35,
  ...
  },
  {
    ...
    chemFraction: 0.0,
    notes: "Kable elektryczne, wiązki przewodów, kable zasilające, kable danych — miedź + plastik. Brak metali szlachetnych. Wartość z odzysku miedzi: 10–25 zł/kg surowych kabli. Nie trawimy — poza zakresem kalkulatora metali szlachetnych.",
  },
  {
    id: "ufo_mix",
