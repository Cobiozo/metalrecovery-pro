...
export const electronicMaterials = [
  ...
  {
    id: "tablet_bez_baterii",
    name: "Tablety (bez baterii)",
    nameEn: "Tablets (no battery)",
    category: "urzadzenie",
    unit: "kg",
    weightPerPiece: 0.40,
    chemFraction: 0.34,
    ...
    metalContentPerKg: {
      ...
      Ag: { min: 0.12, max: 0.50, typical: 0.24 },
      Pt: { min: 0.0, max: 0.003, typical: 0.001 },
      Pd: { min: 0.004, max: 0.025, typical: 0.011 },
    },
    notes: "Tablety bez baterii (~400g/szt po usunięciu baterii ~150g). Au wyższe niż z baterią bo ciężka bateria nie rozcieńcza frakcji metalicznej. chemFraction=0.34 — PCB ~34% masy korpusu.",
  },
  {
    id: "router",
    name: "Routery",
