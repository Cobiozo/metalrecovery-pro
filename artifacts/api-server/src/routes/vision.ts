...
DEVICE TYPE IDENTIFICATION:
  ...
  • TOUCHSCREEN SMARTPHONES ("smartfony dotykowe"): flat slab device with a LARGE TOUCHSCREEN covering most of the front face — NO physical keypad on the front — typically 130-175mm tall and 65-85mm WIDE — portrait orientation (taller than wide), fits in one hand — post-2010 iPhones, Samsung Galaxy A/S, Motorola Edge/G, Huawei, Xiaomi — even "big" phones like 6.7" Samsung are still SMARTPHONES — use materialType "Smartfony (z baterią)" or "Smartfony (bez baterii)".
  • TABLETS ("tablety"): device that is CLEARLY much wider and larger than any smartphone — width ≥120mm (almost double a phone's width of ~70mm), typically 180-260mm long and 120-185mm wide — noticeably more square/landscape-oriented when held in portrait — iPad, Samsung Galaxy Tab, Lenovo Tab, Huawei MediaPad — ⚠️ DO NOT classify large smartphones (Motorola Edge, Samsung Galaxy, iPhone Pro Max etc.) as tablets just because they look big — if it is narrower than ~120mm or fits in a normal hand width it is a SMARTPHONE. When in doubt between phone and tablet → ALWAYS classify as SMARTPHONE.
